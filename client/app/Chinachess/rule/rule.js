...
var Rule = (function () {
    ...
    Rule.prototype.hasPieceOnRows = function (col, minRow, maxRow, boardStates) {
    ...
    Rule.prototype.numPieceOnRows = function (col, minRow, maxRow, boardStates) {
        var r = 0;
        for (var i = minRow; i <= maxRow; i++) {
            if (boardStates[[i, col].toString()])
                r += 1;
    ...
    Rule.prototype.filterBoundedMoves = function (currRow, currCol, moves, boardStates) {
        var _this = this;
    ...
    Rule.prototype.movesOnSameLine = function (currRow, currCol, boardStates) {
        var moves = [];
    ...
    // Ju
    Rule.prototype.possibleMovesForJu = function (currRow, currCol, boardStates) {
        return this.movesOnSameLine(currRow, currCol, boardStates);
    };
    // Ma
    Rule.prototype.possibleMovesForMa = function (currRow, currCol, boardStates) {
        var moves = [];
    ...
    Rule.prototype.findFirstOpponentOnRow = function (row, startCol, states, team, incFn) {
    ...
    Rule.prototype.findFirstOpponentOnCol = function (col, startRow, states, team, incFn) {
    ...
    // Pao
    Rule.prototype.possibleMovesForPao = function (currRow, currCol, boardStates, team) {
    ...
    // Shi
    Rule.prototype.possibleMovesForShi = function (currRow, currCol, boardStates, isLowerTeam) {
        var moves = [];
    ...
    // King
    Rule.prototype.possibleMovesForKing = function (currRow, currCol, boardStates) {
        var moves = [];
    ...
    // Xiang
    Rule.prototype.possibleMovesForXiang = function (currRow, currCol, boardStates, isLowerTeam) {
        var moves = [];
    ...
    // Zu
    Rule.prototype.possibleMovesForZu = function (currRow, currCol, boardStates, isLowerTeam) {
